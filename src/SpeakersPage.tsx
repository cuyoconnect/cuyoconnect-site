            ...
            >
              <div className="flex flex-col gap-6">
                <div>
                  <label
                    htmlFor={topicsId}
                    className="block text-base font-semibold tracking-tight text-neutral-950"
                  >
                  ...
                  <textarea
                    ...
                    aria-describedby={`${topicsId}-hint`}
                    className={cn(
                      'mt-4 min-h-[10rem] w-full resize-y rounded-xl border border-neutral-200 bg-neutral-50/60 px-4 py-3 text-base leading-relaxed text-neutral-950',
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-8">
                      <div className="flex min-w-0 flex-wrap items-center justify-center gap-x-3 gap-y-1 sm:justify-start">
                        ...
                        <label htmlFor={durationId} className="sr-only">
                          Elegí la duración de la charla
                        </label>
                        <select
                          id={durationId}
                          name="duration"
                          ...
                          onChange={(e) =>
                            setDuration(
                              e.target
                                .value as (typeof DURATION_OPTIONS)[number]['value'],
                            )
                          }
                          className={cn(
                            'cursor-pointer border-0 bg-transparent p-0 text-sm font-semibold text-neutral-950 underline decoration-neutral-300 underline-offset-[0.2em]',
