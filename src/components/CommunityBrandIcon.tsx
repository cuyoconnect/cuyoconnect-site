...
import type { CommunityLinkId } from '@/lib/community-links'
...
export function CommunityBrandIcon({ id, className }: Props) {
  ...
  switch (id) {
    ...
    /** Lucide `megaphone` (lucide-static) — anuncios; mismo lenguaje de trazo que `luma`. */
    ...
    case 'x':
      return (
        <svg
          className={cn(cls, 'text-neutral-950')}
          viewBox="0 0 24 24"
          fill="currentColor"
          aria-hidden
        >
